...
const FAQS = [
  ...
  {
    q: "איך Centro מתחבר לוואטסאפ וגוגל דרייב?",
  ...
  {
    q: "כמה זמן לוקח להתחיל לעבוד עם Centro?",
    a: "בין 2 ל־5 דקות. נרשמים, מחברים WhatsApp וגוגל דרייב, ו־Centro מתחיל לעבוד באותו רגע — בלי התקנות ובלי הדרכה מורכבת.",
  },
];
