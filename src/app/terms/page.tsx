    ...
    <main className="flex min-h-screen justify-center bg-background px-4 py-16">
      <div className="w-full max-w-2xl">
        ...
        <div className="rounded-2xl border border-border bg-surface p-8 shadow-card-lg">
          <h1 className="mb-3 text-2xl font-semibold text-text-primary">תנאי שימוש</h1>
          <p className="text-sm leading-relaxed text-text-secondary">
            הנוסח המלא של תנאי השימוש ב-Centro יפורסם כאן בקרוב. במידה ויש לכם שאלות
            בנוגע לתנאי השימוש בשירות, ניתן ליצור קשר בכתובת{" "}
